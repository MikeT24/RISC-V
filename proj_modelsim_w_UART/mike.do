...
add wave -noupdate /risc_v_mike_tb_uni/dut/i_UART_UNCORE/i_risc_v_mike_gpio_module/tx_data_ff
...
add wave -noupdate -radix hexadecimal -radixenum numeric /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/intr_opcode_e
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/intr_opcode_e
add wave -noupdate /risc_v_mike_tb_uni/dut/i_UART_UNCORE/tx_send
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/data_hzd_nuke_e_internal
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/data_hzd_nuke_m_internal
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/data_hzd_nuke_w_internal
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/data_hzd_nuke_w_plus1_internal
add wave -noupdate /risc_v_mike_tb_uni/dut/i_risc_v_mike_ctrl/data_hzd_nuke_w_plus2_internal
...
add wave -noupdate -radix hexadecimal {/risc_v_mike_tb_uni/dut/i_risc_v_mike_data_memory/data_mem_ff[20]}
...
add wave -noupdate /risc_v_mike_tb_uni/dut/pc_src_e
add wave -noupdate /risc_v_mike_tb_uni/dut/intr_nmen_e
add wave -noupdate -radix hexadecimal /risc_v_mike_tb_uni/dut/instruction_f
add wave -noupdate /risc_v_mike_tb_uni/dut/intr_nmen_m
add wave -noupdate /risc_v_mike_tb_uni/dut/intr_nmen_w
add wave -noupdate /risc_v_mike_tb_uni/dut/pc_addr_f
add wave -noupdate /risc_v_mike_tb_uni/dut/pc_addr_nxt_f
add wave -noupdate /risc_v_mike_tb_uni/dut/clk
add wave -noupdate /risc_v_mike_tb_uni/dut/clk_in
add wave -noupdate /risc_v_mike_tb_uni/dut/rst_internal
...
WaveRestoreCursors {{Cursor 1} {199761 ps} 0} {{Cursor 2} {54 ps} 0} {{Cursor 3} {795 ps} 0}
