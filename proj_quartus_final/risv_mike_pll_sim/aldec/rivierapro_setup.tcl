...
# ACDS 22.1 922 win32 2024.05.08.12:34:06
# ----------------------------------------
...
# ----------------------------------------
# If risv_mike_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "risv_mike_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/risv_mike_pll.vo"
}
